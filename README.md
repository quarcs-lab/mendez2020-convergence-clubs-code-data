...
| [Convergence clubs analysis using R](https://journal.r-project.org/archive/2019/RJ-2019-021/index.html) | [Download R dataset of developed countries](assets/dat_hiNo.zip?raw=true)                                                |
| [Explore the data using Python in Google Colab](https://colab.research.google.com/github/quarcs-lab/mendez2020-convergence-clubs-code-data/blob/master/assets/dat.ipynb)                                                    | [Download R dataset of developing countries](assets/dat_hiYes.zip?raw=true)                                              |
| [Explore the data using R in R Studio Cloud](https://rstudio.cloud/project/1358320)                     |                                                                                                                          |
