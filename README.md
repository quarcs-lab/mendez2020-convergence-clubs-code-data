...
| [Video Tutorial]()                                                                  | [Download CSV full dataset](assets/dat.csv.zip?raw=true)                                                                 |
|-------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------|
| [Explore the data using R in R Studio Cloud](https://rstudio.cloud/project/1358320) | [Download CSV dataset definitions](assets/dat-definitions.csv.zip?raw=true)                                              |
